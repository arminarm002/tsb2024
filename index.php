            ...
            <div class="row" style="margin: 15px auto;">
              <div class="col-sm-12 col-md-6 col-lg-4 centerer mt-3">
                <div class="card border border-warning rounded" style="width: 28rem;"><!-- 18rem -->
                  <img class="border-bottom border-warning" src="/spc2024/img/news/speaker1.jpg"
                    style="width:100%; ">
                  <div class="card-body">
                    <h5 class="card-title"> 12 February 2024</h5>
                    <p class="card-text" style="text-align:justify;">The updated list of plenary talks includes presentations by Prof. Yifang Wang And Prof. Albrecht Karle</p>
